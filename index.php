...
<head>
  ...
  <title>PDSI - Homepage </title><!-- Styles-->
              ...
              <div class="header-content">
                <nav class="nav-menu">
                  ...
                  <div class="scrollactive-nav show-lg-up multi-menu scrollnav">
                    <ul class="main-menu">
                      <li>
                        <a class="btn btn-flat anchor-link waves-effect" href="#facility">berita</a>
                      </li>
                      <li>
                        <a class="btn btn-flat anchor-link waves-effect" href="#testimonials">testimoni</a>
                      </li>
                      <li>
                        <a class="btn btn-flat anchor-link waves-effect" href="#clinics">mitra</a>
                      </li>
                      <li>
          ...
          <main class="container-wrap">
                          ...
                          <div class="container">
                            <div class="row">
                              <div class="col-md-7 col-lg-6 col-sm-12 px-sm-6 px-0 d-flex align-items-center order-lg-1">
                                <div class="text">
                                  <h4 class="use-text-title">Online Medical Care</h4>
                                  <h5 class="use-text-subtitle">Get a diagnosis, treatment plan, and prescription from original provider of quality medical care.</h5>
                                </div>
                              </div>
                ...
                <div class="container max-lg">
                  <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-sm-4 col-lg-3 px-6">
                      ...
                      <p class="text-center">Materi pelatihan tersedia 24 jam untuk belajar fleksibel kapan saja.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section class="space-top-short" id="facility">
              <div class="root">
                <div class="container carousel-header">
                  <div class="text">
                    <h4 class="use-text-title">Berita</h4>
                    <p class="use-text-subtitle2">Tingkatkan pengetahuan dan keterampilan klinis Anda melalui modul pelatihan interaktif dan bersertifikat.</p>
                  </div><a class="btn-flat primary-text waves-effect view-all" href="blog.html">see all<i class="material-icons icon">arrow_forward</i></a>
                </div>
                ...
                <div class="container">
                  <div class="row spacing8">
                    <div class="col-md-6 col-sm-12 px-sm-12">
                      <h4 class="use-text-title">Spesialisasi Kami</h4>
                      <p class="desc use-text-subtitle2">Semua instruktur di Platform Kursus Medis kami adalah dokter berlisensi dan ahli di bidangnya masing-masing.</p>
            ...
            <section class="space-top-short" id="testimonials">
              ...
              <div class="root">
                <div class="container carousel-header">
                  <div class="px-3">
                    <h4 class="use-text-title text-capitalize">Testimoni Dokter</h4>
                    <p class="use-text-subtitle2">Apa kata para dokter tentang pengalaman mereka mengikuti kursus ini.</p>
                  </div>
                </div>
                <div class="carousel">
            ...
            <section class="space-top-short space-bottom-short" id="clinics">
              <div class="root">
                <div class="container mq-md-up" data-class="fixed-width">
                  <div class="pa-3">
                    <h4 class="use-text-title text-capitalize">Mitra Kami</h4>
