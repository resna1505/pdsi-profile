                    ...
                    <div class="collapsible-body">
                      <div class="collection side-group">
                        <ul class="group-child">
                          ...
                          <li class="collection-item side-group-link">
                            <a class="waves-effect text-truncate menu-list current" href="about-team.php">Tim Pengajar & Ahli</a>
                          </li>
                          <li class="collection-item side-group-link">
                              ...
                              <div class="row">
                                <div class="col-sm-3 mb-6">
                                  ...
                                  <ul>
                                    ...
                                    <li class="waves-effect"><a class="menu-list current" href="about-team.php">Tim Pengajar & Ahli</a></li>
