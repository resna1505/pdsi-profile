...
<head>
  ...
  <title>Medical - Not Found </title><!-- Styles-->
                  ...
                  <div class="collapsible-body">
                    <div class="collection side-group">
                      ...
                      <ul class="group-child">
                        ...
                        <li class="collection-item side-group-link">
                          <a class="waves-effect text-truncate menu-list current" href="404.html">error</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-3 mb-6">
                                ...
                                <ul>
                                  ...
                                  <li class="waves-effect"><a class="menu-list current" href="404.html">error not found</a></li>
                                </ul>
                              </div>
                            </div>
                          </div>
                ...
                <div class="col-md-5 col-sm-12">
                  <div class="flex">
                    <div class="illustration">
                      <img class="img-2d3d" src="./assets/images/medical/error_3d@2x.png" data-2d="./assets" data-3d="./assets/images/medical/error_3d@2x.png" alt="error" />
                    </div>
                  </div>
                </div>
                <div class="col-md-7 col-sm-12">
                  <div class="text">
                    <h3 class="use-text-primary">404</h3>
                    <h4 class="use-text-subtitle">This page could not be found.</h4>
                    <p class="use-text-paragraph">You can either stay and chill here, or go back to the beginning.</p>
                    <a class="btn primary waves-effect btn-large button" href="index.html">back to home</a>
                  </div>
                </div>
              </div>
            </div>
