      ...
      <div id="faq-page">
        <div class="main-wrap">
          ...
          <div class="container-wrap">
                      ...
                      <col-sm-12>
                        ...
                        <div class="search">
                          <div class="input-field">
                            ...
                            <input id="search_product" type="text" placeholder="I'm looking for...">
                          </div>
                        </div>
                      </col-sm-12>
                    </div>
            ...
            <div class="container space-top-short">
              <div class="row justify-content-center">
                <!-- ##### FAQ #####-->
                <div class="col-md-6 col-sm-12 px-sm-6 px-0">
                  <div class="faq-style">
                    <div class="faq-group" id="topic1">
                      <div class="use-text-subtitle mb-3">Pertanyaan FAQ yang Disarankan</div>
                      <div class="accordion">
                        <ul class="collapsible">
                          <li class="accordion-content paper active">
                            <div class="collapsible-header content">
                              <p class="heading">Bagaimana cara mendaftar menjadi anggota organisasi?</p>
                          ...
                          <li class="accordion-content paper">
                            <div class="collapsible-header content">
                              <p class="heading">Apa saja syarat dan dokumen yang dibutuhkan untuk keanggotaan?</p>
                              <i class="material-icons right arrow">expand_more</i>
                            </div>
                            <div class="collapsible-body detail">
                              <p>Vivamus sit amet interdum elit. Proin lacinia erat ac velit tempus auctor. </p>
                          ...
                          <li class="accordion-content paper">
                            <div class="collapsible-header content">
                              <p class="heading">Bagaimana prosedur pembayaran iuran anggota?</p>
                              <i class="material-icons right arrow">expand_more</i>
                            </div>
                            <div class="collapsible-body detail">
                              <p>Vivamus sit amet interdum elit. Proin lacinia erat ac velit tempus auctor. </p>
                          ...
                          <li class="accordion-content paper">
                            <div class="collapsible-header content">
                              <p class="heading">Bagaimana cara mendapatkan sertifikat kegiatan ilmiah atau seminar?</p>
                              <i class="material-icons right arrow">expand_more</i>
                            </div>
                            <div class="collapsible-body detail">
                              <p>Vivamus sit amet interdum elit. Proin lacinia erat ac velit tempus auctor. </p>
                          ...
                          <li class="accordion-content paper">
                            <div class="collapsible-header content">
                              <p class="heading">Apa yang harus dilakukan jika lupa akun atau password aplikasi?</p>
                              <i class="material-icons right arrow">expand_more</i>
                            </div>
                            <div class="collapsible-body detail">
                              <p>Vivamus sit amet interdum elit. Proin lacinia erat ac velit tempus auctor. </p>
                    ...
                    <div class="faq-group" id="topic2">
                      <div class="use-text-subtitle mb-3">Pertanyaan FAQ yang Disarankan</div>
                      <div class="accordion">
                        <ul class="collapsible">
                          <li class="accordion-content paper active">
                            <div class="collapsible-header content">
                              <p class="heading">Bagaimana cara mengakses laporan kehadiran atau pelatihan?</p>
                              <i class="material-icons right arrow">expand_more</i>
                            </div>
                            <div class="collapsible-body detail">
                              <p>Vivamus sit amet interdum elit. Proin lacinia erat ac velit tempus auctor.</p>
                          ...
                          <li class="accordion-content paper">
                            <div class="collapsible-header content">
                              <p class="heading">Apakah aplikasi menyediakan forum diskusi antar dokter?</p>
                              <i class="material-icons right arrow">expand_more</i>
                            </div>
                            <div class="collapsible-body detail">
                              <p>Vivamus sit amet interdum elit. Proin lacinia erat ac velit tempus auctor. </p>
                          ...
                          <li class="accordion-content paper">
                            <div class="collapsible-header content">
                              <p class="heading">Bagaimana cara mengajukan izin atau cuti keanggotaan?</p>
                              <i class="material-icons right arrow">expand_more</i>
                            </div>
                            <div class="collapsible-body detail">
                              <p>Vivamus sit amet interdum elit. Proin lacinia erat ac velit tempus auctor. </p>
                          ...
                          <li class="accordion-content paper">
                            <div class="collapsible-header content">
                              <p class="heading">Apa saja manfaat dan fasilitas bagi anggota aktif?</p>
                              <i class="material-icons right arrow">expand_more</i>
                            </div>
                            <div class="collapsible-body detail">
                              <p>Vivamus sit amet interdum elit. Proin lacinia erat ac velit tempus auctor. </p>
                          ...
                          <li class="accordion-content paper">
                            <div class="collapsible-header content">
                              <p class="heading">Siapa yang dapat dihubungi jika ada kendala teknis dalam aplikasi?</p>
                              <i class="material-icons right arrow">expand_more</i>
                            </div>
                            <div class="collapsible-body detail">
                              <p>Vivamus sit amet interdum elit. Proin lacinia erat ac velit tempus auctor. </p>
                    ...
                    <!-- <div class="faq-group" id="topic3">
                      <div class="use-text-subtitle mb-3">Lorem ipsum dolor sit amet</div>
                      <div class="accordion">
                        <ul class="collapsible">
                          <li class="accordion-content paper active">
                            <div class="collapsible-header content">
                              <p class="heading">Pellentesque ac bibendum tortor?</p>
                              <i class="material-icons right arrow">expand_more</i>
                            </div>
                            <div class="collapsible-body detail">
                              <p>Vivamus sit amet interdum elit. Proin lacinia erat ac velit tempus auctor.</p>
                          ...
                          <li class="accordion-content paper">
                            <div class="collapsible-header content">
                              <p class="heading">In mi nulla, fringilla vestibulum?</p>
                              <i class="material-icons right arrow">expand_more</i>
                            </div>
                            <div class="collapsible-body detail">
                              <p>Vivamus sit amet interdum elit. Proin lacinia erat ac velit tempus auctor. </p>
                          ...
                          <li class="accordion-content paper">
                            <div class="collapsible-header content">
                              <p class="heading">Quisque lacinia purus ut libero?</p>
                              <i class="material-icons right arrow">expand_more</i>
                            </div>
                            <div class="collapsible-body detail">
                              <p>Vivamus sit amet interdum elit. Proin lacinia erat ac velit tempus auctor. </p>
                          ...
                          <li class="accordion-content paper">
                            <div class="collapsible-header content">
                              <p class="heading">Quisque ut metus sit amet augue?</p>
                              <i class="material-icons right arrow">expand_more</i>
                            </div>
                            <div class="collapsible-body detail">
                              <p>Vivamus sit amet interdum elit. Proin lacinia erat ac velit tempus auctor. </p>
                ...
                <div class="col-md-4 col-sm-12 px-sm-6 pt-10 pt-sm-0">
                  <div class="space-bottom-short">
                    <div class="faq-style">
                      ...
                      <ul class="topic-list">
                        <li><a href="#topic1">Keanggotaan</a></li>
                        <li><a href="#topic2">Pembayaran Iuran</a></li>
                        <li><a href="#topic3">Kegiatan Ilmiah</a></li>
                        <li><a href="#topic4">Sertifikat</a></li>
                        <li><a href="#topic5">Akun & Akses Aplikasi</a></li>
                        <li><a href="#topic6">Layanan Bantuan</a></li>
                      </ul>
                    </div>
                  </div>
                  <!-- <div class="space-bottom-short">
                    <div class="list-style">
                      <div class="card help-paper text-center">
                        <div class="card-content">
                          <h6 class="use-text-bold text-center mb-3">Still no luck? We can help!</h6>
                          <p class="mb-3">Contact us and we’ll get back to you as soon as possible.</p>
                          <div class="card-actions">
                            <a class="btn block primary" href="#!">submit a request</a>
                          </div>
                        </div>
                      </div>
                    </div>
