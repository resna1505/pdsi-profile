                    ...
                    <div class="collapsible-body">
                      <div class="collection side-group">
                        ...
                        <ul class="group-child">
                          ...
                          <li class="collection-item side-group-link">
                            <a class="waves-effect text-truncate menu-list current" href="faq.php">frequently answer &amp; questions</a>
                          </li>
                        </ul>
                      </div>
                    </div>
                            ...
                            <div class="container max-md">
                              <div class="row">
                                ...
                                <div class="col-sm-3 mb-6">
                                  ...
                                  <ul>
                                    <li class="waves-effect"><a class="menu-list current" href="faq.php">frequently answer &amp; questions</a></li>
                                  </ul>
                                </div>
                              </div>
                            </div>
