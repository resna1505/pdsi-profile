...
$languages = [
    'id' => [
        ...
        // Banner
        'banner_title' => 'Struktur Organisasi',
        'banner_subtitle' => 'Sebagai lembaga sertifikasi terakreditasi, kami memiliki struktur organisasi yang solid dan profesional untuk memastikan setiap proses berjalan sesuai standar mutu yang ditetapkan',
    ...
    'en' => [
        ...
        // Banner
        'banner_title' => 'struktur organisasi',
        'banner_subtitle' => 'As an accredited certification body, we have a solid and professional organizational structure to ensure that every process runs according to the established quality standards.',
                                        ...
                                        <div class="collapsible-body">
                                            <div class="collection side-group">
                                                ...
                                                <ul class="group-child">
                                                    ...
                                                    <li class="collection-item side-group-link">
                                                        <a class="waves-effect text-truncate menu-list current" href="struktur.php"><?php echo $text['mega_struktur']; ?></a>
                                                    </li>
                                                </ul>
                                                <ul class="group-child">
                                                    <li class="collection-header">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-3 mb-6">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li class="waves-effect"><a class="menu-list current" href="struktur.php"><?php echo $text['mega_struktur']; ?></a></li>
                                                                    </ul>
                                                                </div>
                                                                <div class="col-sm-3 mb-6">
                                                                    <div class="title-mega"><?php echo $text['mega_faq']; ?></div>
