    ...
    <div class="m-content fresh fresh-var" id="main-wrap">
      <div id="about-page">
        <div class="main-wrap">
                    ...
                    <div class="collapsible-body">
                      <div class="collection side-group">
                        ...
                        <ul class="group-child">
                          ...
                          <li class="collection-item side-group-link">
                            <a class="waves-effect text-truncate menu-list current" href="gallery.html">Galeri</a>
                          </li>
                        </ul>
                        <ul class="group-child">
                          <li class="collection-header">
                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-3 mb-6">
                                  ...
                                  <ul>
                                    ...
                                    <li class="waves-effect"><a class="menu-list current" href="gallery.html">Galeri</a></li>
                                  </ul>
                                </div>
                                <div class="col-sm-3 mb-6">
                                  <div class="title-mega">FAQ</div>
          ...
          <!-- ##### PHOTO #####-->
          <div class="space-top-short" style="margin-top: 8%;">
                ...
                <div class="carousel">
                  ...
                  <div class="photo-carousel" id="about_photo_carousel">
                    <div class="item px-sm-3 px-1 showImg" data-index="0">
                      <div class="showimg">
                        <a class="waves-effect" href="./assets/images/medical/LnfxU_1668266245.jpg"><img src="./assets/images/medical/LnfxU_1668266245.jpg" alt="photo" /></a>
                      </div>
                      <div class="card media-card portrait photo">
                        <a class="cover-link waves-effect" href="./assets/images/medical/LnfxU_1668266245.jpg"></a>
                        <figure><img src="./assets/images/medical/LnfxU_1668266245.jpg" alt="cover" /></figure>
                        <div class="property">
                          <div class="card-title media-title">Persentasi 1</div>
                        </div>
                      </div>
                    </div>
                    <div class="item px-sm-3 px-1 showImg" data-index="1">
                      <div class="showimg">
                        <a class="waves-effect" href="./assets/images/medical/qQhl7_1668266265.jpg"><img src="./assets/images/medical/qQhl7_1668266265.jpg" alt="photo" /></a>
                      </div>
                      <div class="card media-card portrait photo">
                        <a class="cover-link waves-effect" href="./assets/images/medical/qQhl7_1668266265.jpg"></a>
                        <figure><img src="./assets/images/medical/qQhl7_1668266265.jpg" alt="cover" /></figure>
                        <div class="property">
                          <div class="card-title media-title">Persentasi 2</div>
                        </div>
                      </div>
                    </div>
                    <div class="item px-sm-3 px-1 showImg" data-index="2">
                      <div class="showimg">
                        <a class="waves-effect" href="./assets/images/medical/tc0jM_1668266288.jpg"><img src="./assets/images/medical/tc0jM_1668266288.jpg" alt="photo" /></a>
                      </div>
                      <div class="card media-card portrait photo">
                        <a class="cover-link waves-effect" href="./assets/images/medical/tc0jM_1668266288.jpg"></a>
                        <figure><img src="./assets/images/medical/tc0jM_1668266288.jpg" alt="cover" /></figure>
                        <div class="property">
                          <div class="card-title media-title">Persentasi 3</div>
                        </div>
                      </div>
                    </div>
