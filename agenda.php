...
<head>
  ...
  <title>PDSI - Agenda </title><!-- Styles-->
    ...
    <div class="m-content fresh fresh-var" id="main-wrap">
      <div id="blog-page">
        <div class="main-wrap">
                    ...
                    <div class="collapsible-body">
                      <div class="collection side-group">
                        ...
                        <ul class="group-child">
                          ...
                          <li class="collection-item side-group-link">
                            <a class="waves-effect text-truncate menu-list current" href="agenda.php">Agenda</a>
                          </li>
                        </ul>
                        <ul class="group-child">
                          <li class="collection-header">
                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-3 mb-6">
                                  ...
                                  <ul>
                                    ...
                                    <li class="waves-effect"><a class="menu-list current" href="agenda.php">Agenda</a></li>
                                  </ul>
                                </div>
                                <div class="col-sm-3 mb-6">
                                  <div class="title-mega">FAQ</div>
          ...
          <?php
          // Fetch data from API
          $apiUrl = "http://localhost:8000/api/agenda";
                          ...
                          <div class="card post-card portrait full">
                            ...
                            <div class="properties">
                              ...
                              <div class="card-action">
                                <a class="btn btn-outlined primary action-btn waves-effect" href="detail-agenda.php?id=<?php echo $article['id']; ?>">read more</a>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="content">
                            <div>
                              <div class="collection">
                                ...
                                ?>
                                  <a class="waves-effect collection-item" href="detail-agenda.php?id=<?php echo $latest['id']; ?>">
