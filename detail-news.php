...
$languages = [
  'id' => [
    'site_title' => 'PDSI - Detail Berita',
    'meta_description' => 'Detail berita terkini PDSI - Informasi lengkap tentang perkembangan dunia kedokteran',
...
Daerah Khusus Ibukota Jakarta 12310',
  ...
  'en' => [
    'site_title' => 'PDSI - News Details',
    'meta_description' => 'Latest PDSI news details - Complete information about medical world developments',
                    ...
                    <div class="collapsible-body">
                      <div class="collection side-group">
                        <ul class="group-child">
                          ...
                          <li class="collection-item side-group-link">
                            <a class="waves-effect text-truncate menu-list current" href="news.php"><?php echo $text['mega_news']; ?></a>
                          </li>
                        </ul>
                        <ul class="group-child">
                          <li class="collection-header">
                              ...
                              <div class="row">
                                <div class="col-sm-3 mb-6">
                                  ...
                                  <ul>
                                    ...
                                    <li class="waves-effect"><a class="menu-list current" href="news.php"><?php echo $text['mega_news']; ?></a></li>
                                  </ul>
                                </div>
                                <div class="col-sm-3 mb-6">
                                  <div class="title-mega"><?php echo $text['mega_activities']; ?></div>
                      ...
                      <div class="setting">
                        ...
                        <div class="dropdown-content setting" id="dropdown_config">
                          ...
                          <ul class="collection with-header lang-menu" id="lang_menu">
                            ...
                            <li class="collection-item lang-list waves-effect avatar <?php echo ($currentLang == 'en') ? 'active' : ''; ?>">
                            ...
                            <li class="collection-item lang-list waves-effect avatar <?php echo ($currentLang == 'id') ? 'active' : ''; ?>">
                ...
                <?php if ($articleNotFound): ?>
                  ...
                  <div class="col-12">
                    <div class="alert alert-danger text-center">
                      ...
                      <a href="news.php?lang=<?php echo $currentLang; ?>" class="btn btn-primary waves-effect">
                        <?php echo $text['mega_news']; ?>
                      </a>
                    </div>
                  </div>
                <?php else: ?>
                    ...
                    <div class="blog-style">
                      <article class="blog-content">
                        ...
                        <div class="mt-4 d-flex gap-3 align-items-center">
                          <!-- Share via WhatsApp -->
                          <a href="https://wa.me/?text=<?php echo urlencode($article['title'] . ' - https://pdsionline.org/detail-news.php?id=' . $articleId); ?>" target="_blank" title="Bagikan ke WhatsApp">
                        ...
                        <div class="content">
                          <div>
                            <div class="collection">
                              ...
                              ?>
                                <a class="waves-effect collection-item" href="detail-news.php?id=<?php echo $latest['id']; ?>&lang=<?php echo $currentLang; ?>">
                                  <span class="d-block"><?php echo htmlspecialchars($latest['title']); ?></span>
                                  <span class="caption"><?php echo $latestDate; ?></span>
                                </a>
                              <?php endforeach; ?>
                            </div>
                            <a class="btn waves-effect btn-flat primary-text block" href="news.php?lang=<?php echo $currentLang; ?>"><?php echo $text['sidebar_see_all']; ?></a>
                          </div>
                        </div>
                      </div>
                    </div>
